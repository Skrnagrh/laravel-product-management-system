    ...
    <nav class="main-header navbar navbar-expand navbar-detached d-flex justify-content-between bg-navbar-theme px-3">
        <div class="container">
            <a class="navbar-brand text-primary" href="/">
                <img src="/assets/logo.png" alt="Logo" class="img-fluid" style="max-width: 50px;">
                <span class="fs-3 mt-3" style="color: #21366F">Product Management System</span>
            </a>
        ...
        <div class="p-4">
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <img src="/assets/logo.png" class="img-fluid" style="max-width: 250px;">
                    <h2 class="text-capitalize" style="color: #00154e">
                        Product Management System
                    </h2>

                    <p class="lead" style="color: #00154e">
                        Aplikasi ini mencakup fitur autentikasi, operasi CRUD, upload file, audit trail, serta ekspor
                        dan impor file Excel.
                    </p>
